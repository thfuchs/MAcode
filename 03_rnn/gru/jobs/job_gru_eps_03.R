...
fc_eps_rnn_predict <- readRDS("03_rnn/gru/results/fc_eps_rnn_predict.rds")
...
if (length(purrr::compact(fc_eps_rnn_eval)) > 0) {
  saveRDS(fc_eps_rnn_eval, file = "03_rnn/gru/results/fc_eps_rnn_eval.rds", compress = "xz")
  toSlack("GRU EPS evaluation finished")
} else toSlack("Error: GRU EPS evaluation failed")
