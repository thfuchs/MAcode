...
fc_ebit_rnn_prediction <- readRDS("03_rnn/simple/results/fc_ebit_rnn_prediction.rds")
...
if (length(purrr::compact(fc_ebit_rnn_eval)) > 0) {
  saveRDS(fc_ebit_rnn_eval, file = "03_rnn/simple/results/fc_ebit_rnn_eval.rds", compress = "xz")
