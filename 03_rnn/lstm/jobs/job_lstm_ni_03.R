...
fc_ni_rnn_predict <- readRDS("03_rnn/lstm/results/fc_ni_rnn_predict.rds")
...
if (length(purrr::compact(fc_ni_rnn_eval)) > 0) {
  saveRDS(fc_ni_rnn_eval, file = "03_rnn/lstm/results/fc_ni_rnn_eval.rds", compress = "xz")
  toSlack("LSTM Net Income evaluation finished")
} else toSlack("Error: LSTM Net Income evaluation failed")
